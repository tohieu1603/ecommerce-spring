package com.example.auth_service.interfaces.rest.support;
...
public class AuthCookieWriter {
    ...
    public ResponseEntity<AuthResponseDTO> writeTokens(AuthResponseDTO source) {
        ResponseCookie access = baseCookie(ACCESS_COOKIE, source.accessToken(),
                ...
                .path("/")
                .build();
        ResponseCookie refresh = baseCookie(ACCESS_COOKIE, source.refreshToken(),
    ...
    public void expire(HttpHeaders headers) {
