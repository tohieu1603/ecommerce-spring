...
public class JwtTokenProvider implements TokenProviderPort{
     ...
     */
    @Override
    public IssuedAccessToken issueAccessToken(User user, Set<String> roles, Set<String> permissions) {
    ...
    public AccessClaims parseAccessToken(String token) {
        ...
        @SuppressWarnings("unchecked")
        Set<String> permissions = Set.copyOf((Collection<String>) c.getOrDefault("permissions", Set.of()));
