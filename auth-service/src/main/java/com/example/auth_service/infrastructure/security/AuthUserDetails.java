...
public final class AuthUserDetails implements UserDetails{
     ...
     */
    public static AuthUserDetails from(User user, Set<String> roleName, Set<String> permissionName) {
        Set<GrantedAuthority> authorities = new LinkedHashSet<>();

        roleName.forEach(r -> authorities.add(new SimpleGrantedAuthority(r)));
        permissionName.forEach(p -> authorities.add(new SimpleGrantedAuthority(p)));
