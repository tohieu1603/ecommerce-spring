 ...
 * 
 * <p> Used by auth-side use case (logout, password change, admin revoked) and by the
...
public interface TokenBlacklistPort {
    ...
    /**
     * Revoked an access token by its {@code jti}
     ...
     * 
     * @param tokenId
     * @return {@code true} if token has been revoked
     */
